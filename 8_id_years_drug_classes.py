...
meds_class = pd.read_csv('UK Biobank/Processed files/tables/meds_v2_body_system.csv', header=0, dtype = str, encoding = 'cp1252')
...
id_years = id_years[['id', 'year', 'data_provider', 'sex', 'birth_date',
                             'med_age','first_year', 'last_year', 'date_first', 'date_last', 'date_0', 
                             'date_1', 'date_2', 'date_3', 'date_follow_up',
                             'med_centre', 'date', 'med_education', 'med_smoking', 'med_alc_freq', 'med_activity', 'med_bmi',
                             'centre_0', 'centre_2', 'education_0', 'education_2', 'smoking_0', 'smoking_2',
                             'alc_freq_0', 'alc_freq_2', 'activity_0', 'activity_2', 'bmi_0', 'bmi_2',
                             'deprivation', 'meds_count', 'aa_duran', 'aa_duran_n','metabolic', 'antiinfective', 'immuno_modulating',
